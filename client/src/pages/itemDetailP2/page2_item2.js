    ...
    return (
        <div >
            <div class="flex w-[340px] m-auto mt-[30px] justify-between">
                ...
                <p class="flex-none  mt-[5px] "> <BiChevronRight /> </p>
                <p class="flex-none ">Denim Jacket</p>
            </div>
            <Item_detail link="https://cdn.shopify.com/s/files/1/0591/1350/4958/products/35h.jpg?v=1628348161&width=600" name="Denim Jacket" price="$39.00" />
        </div>

    );
}

export default Page2_item2