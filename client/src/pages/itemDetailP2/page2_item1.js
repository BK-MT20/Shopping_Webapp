...
const Page2_item1 = () => {
    return (
        <div >
            ...
            <Item_detail link="https://cdn.shopify.com/s/files/1/0591/1350/4958/products/2_1.jpg?v=1628347876&width=600" name="Oversized Jacket" price="$35.00" />
        </div>

    );
}

export default Page2_item1