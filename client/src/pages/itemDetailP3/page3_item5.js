    ...
    return (
        <div >
            <div class="flex w-[340px] m-auto mt-[30px] justify-between">
                ...
                <p class="flex-none  mt-[5px] "> <BiChevronRight /> </p>
                <p class="flex-none ">Platform espadrille sandals</p>
            </div>
            <Item_detail link="https://cdn.shopify.com/s/files/1/0591/1350/4958/products/34.jpg?v=1628347206&width=600" name="Platform espadrille sandals" price="$25.00" />
        </div>

    );
}

export default Page3_item5