    ...
    return (
        <div >
            <div class="flex w-[340px] m-auto mt-[30px] justify-between">
                ...
                <p class="flex-none  mt-[5px] "> <BiChevronRight /> </p>
                <p class="flex-none ">Jacket De Blouse</p>
            </div>
            <Item_detail link="https://cdn.shopify.com/s/files/1/0591/1350/4958/products/36.jpg?v=1628346789&width=600" name="Jacket De Blouse" price="$40.00" />
        </div>

    );
}

export default Page3_item3